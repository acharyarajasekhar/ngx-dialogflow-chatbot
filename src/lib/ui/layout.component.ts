...
@Component({
  ...
  <div class="chat-container">
    <div class="messages" ngx-auto-scroll lock-y-offset="0" observe-attributes="true" #messagesPanel>
      <ul>  
...
export class LayoutComponent {
  ...
  @ViewChild("messagesPanel") messagesPanel: any;

  constructor(private dialogFlowSvc: NgxDialogflowChatbotService) {
    this.dialogFlowSvc.uiUpdate.subscribe(() => {
      setTimeout(() => {
